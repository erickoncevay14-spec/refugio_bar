// src/components/Mozo/SidebarMozo.jsx (Código corregido)

import React, { useState, useEffect } from "react";
import { useNavigate, useLocation } from 'react-router-dom';
import "./SidebarMozo.css";
// Asegúrate de que SidebarMozo.css apunte correctamente a los estilos globales
// (Si lo renombraste, esta ruta debe ser correcta, si no, usa import "../../styles/Sidebar.css";)

const ICON_BASE_PATH = '/assets/icons/icons/icons-sidebar-navbar/icons/';

const menuItems = [
  { name: 'Mesas', icon: ICON_BASE_PATH + 'file.svg', path: '/mozo/mesas' },
  { name: 'Pedidos Actuales', icon: ICON_BASE_PATH + 'file.svg', path: '/mozo/pedidos-actuales' },
];

const SidebarMozo = ({ onToggle }) => {
  ...
  useEffect(() => {
    try {
      ...
      // Si no existe 'currentUser', muchas implementaciones guardan el nombre en 'userName' o 'username'
  ...
  const handleNavigation = (path) => {
    // Navega con react-router y cierra el menú si es necesario
    navigate(path);
